...
function plot_schrodinger_gaussian_timestep(pb::GreedyDiscretization{T}, nb_timesteps, G0::AbstractWavePacket{D}, V::AbstractWavePacket{D}; plot_result=true) where{T, D}
