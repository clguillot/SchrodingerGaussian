...
function plot_schrodinger_gaussian(pb::GreedyDiscretization{T}, G0::AbstractWavePacket{D}, V::AbstractWavePacket{D}; plot_result=true) where{T, D}
    ...
    G_list, res_list = schrodinger_greedy_gaussian(pb, G0, apply_op)
...
plot_schrodinger_gaussian(pb, G0, V)