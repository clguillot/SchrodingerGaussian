...
function plot_greedy_polynomial_timestep(dis::Discretization, pot::Potential, ::Type{N}, nb_timesteps; plot_result=true) where N 
    ...
    if plot_result
        ...
        g = @gif for k in 1:dis.Nt
            ...
            G = zeros(eltype(G_list), dis.nb_g)
            for j=1:dis.nb_g
...
plot_greedy_polynomial_timestep(dis,pot, Tuple{16},10)